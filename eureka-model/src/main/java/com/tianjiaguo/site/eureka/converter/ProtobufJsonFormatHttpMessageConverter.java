...
package com.tianjiaguo.site.eureka.converter;
...
public class ProtobufJsonFormatHttpMessageConverter extends ProtobufHttpMessageConverter {
     ...
     */
    public ProtobufJsonFormatHttpMessageConverter(
            JsonFormat.Parser parser, JsonFormat.Printer printer) {
     ...
     */
    public ProtobufJsonFormatHttpMessageConverter(JsonFormat.Parser parser,
                                                  JsonFormat.Printer printer, ExtensionRegistryInitializer registryInitializer) {
